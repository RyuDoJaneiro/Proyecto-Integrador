...
<html lang="en">
	...
	<!--end::Head-->
	<!--begin::Body-->
	<body id="kt_body" data-sidebar="on" class=" header-tablet-and-mobile-fixed" style="background-color: #FEDE3B">
		<!--begin::Main-->
		<!--begin::Root-->
        <div class="">
					...
					<div id="kt_header" class="header" data-kt-sticky="true" data-kt-sticky-name="header" data-kt-sticky-offset="{default: '200px', lg: '300px'}">
						...
						<div class="container d-flex align-items-stretch justify-content-between">
							...
							<div class="d-flex align-items-center">
								...
								<!--begin::Logo-->
								<a href="index.html">
								<h1 class="text-dark">🠔 Volver al inicio</h1>		
								</a>
								<!--end::Logo-->
							</div>
							<!--end::Left-->
							...
							<div class="d-flex align-items-center">
								...
								<div class="ms-1 ms-lg-6">
									...
									<div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold w-300px" data-kt-menu="true">
										<div class="menu-content fw-bold d-flex align-items-center bgi-no-repeat bgi-position-y-top rounded-top" style="background-image:url('assets/media//misc/dropdown-header-bg.jpg')">
											...
											<div class="">
												<span class="text-white fw-bolder fs-4"><?php echo htmlspecialchars($_SESSION["username"]); ?></span>
												<span class="text-white fw-bolder fs-4"><?php echo htmlspecialchars($_SESSION["work"]); ?></span>
											</div>
										</div>
										<!--begin::Row-->
										<div class="row row-cols-2 g-0">
											...
											<a href="reset-password.php" class="col text-center border-end py-10 btn btn-active-color-primary rounded-0">
												...
												<!--end::Svg Icon-->
												<span class="fw-bolder fs-6 d-block pt-3">Cambiar contraseña</span>
											</a>
											<a href="logout.php" class="col text-center py-10 btn btn-active-color-primary rounded-0">
												...
												<!--end::Svg Icon-->
												<span class="fw-bolder fs-6 d-block pt-3">Cerrar<br>sesión</span>
											</a>
										</div>
										<!--end::Row-->
									</div>
								...
								<div class="ms-1 ms-lg-6">
									...
									<button class="btn btn-icon btn-sm btn-light-danger fw-bolder pulse pulse-danger" data-kt-menu-trigger="click" data-kt-menu-placement="bottom-end" id="kt_activities_toggle">
										<span class="position-absolute fs-6">1</span>
									...
									<div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded fw-bold menu-title-gray-800 menu-hover-bg menu-state-title-primary w-250px w-md-300px" data-kt-menu="true">
										<div class="menu-item mx-3">
											<div class="menu-content fs-6 text-dark fw-bolder py-6">1 notificación nueva</div>
										</div>
										...
										<div class="menu-item mx-3">
											<a href="#" class="menu-link px-4 py-3">
												...
												<div class="ps-4">
													<span class="menu-title fw-bold mb-1">Turno pendiente para hoy</span>
													<span class="text-muted fw-bold d-block fs-7">Dr. Carlos Montenegro - 17:15 hs</span>
												</div>
											</a>
										</div>
										...
										<div class="menu-item mx-2">
											<div class="menu-content py-5">
												<a href="#" class="btn btn-primary fw-bolder me-2 px-5">Entendido</a>
												<a href="#" class="btn btn-light fw-bolder px-5">Borrar</a>
											</div>
										</div>
									</div>
									<!--end::Menu-->
										...
										<div class="card card-stretch mb-5 mb-xxl-8">
											...
											<div class="card-body pb-0">
												...
												<div class="d-flex flex-column h-100">
													<!--begin::Text-->
													<h3 class="text-dark text-center fs-1 fw-bolder pt-15 lh-lg">¿Necesitas
													<br />ayuda?</h3>
													<!--end::Text-->
													<!--begin::Action-->
													<div class="text-center pt-7">
														<a href="#" class="btn btn-primary fw-bolder fs-6 px-7 py-3" data-bs-toggle="modal" data-bs-target="#kt_modal_create_app">Tutorial</a>
													</div>
													<!--end::Action-->
													<!--begin::Image-->
										...
										<div class="card card-stretch mb-5 mb-xxl-8">
											...
											<div class="card-header border-0 pt-5">
												<h3 class="card-title align-items-start flex-column">
													<span class="card-label fw-bolder text-dark fs-3">Próximos turnos</span>
													<span class="text-muted mt-2 fw-bold fs-6">Actualmente tienes 1 turno asignado</span>
												</h3>
												<div class="card-toolbar">
													<ul class="nav nav-pills nav-pills-sm nav-light">
														<li class="nav-item">
															<a class="nav-link btn btn-active-light btn-color-muted py-2 px-4 active fw-bolder me-2" data-bs-toggle="tab" href="#kt_tab_pane_1_1">1</a>
														</li>
														<li class="nav-item">
															<a class="nav-link btn btn-active-light btn-color-muted py-2 px-4 fw-bolder me-2" data-bs-toggle="tab" href="#kt_tab_pane_1_2">2</a>
														</li>
														<li class="nav-item">
															<a class="nav-link btn btn-active-light btn-color-muted py-2 px-4 fw-bolder" data-bs-toggle="tab" href="#kt_tab_pane_1_3">3</a>
														</li>
													</ul>
												</div>
											</div>
													...
													<div class="tab-pane fade show active" id="kt_tab_pane_1_1" role="tabpanel" aria-labelledby="kt_tab_pane_1_1">
														...
														<div class="table-responsive">
															<table class="table table-borderless align-middle">
																...
																<tbody>
																	<tr>
																		...
																		<td class="ps-0">
																			<a href="#" class="text-gray-800 fw-bolder text-hover-primary fs-6">Dra. Verónica Barrios - Hospital Central</a>
																			<span class="text-muted fw-bold d-block mt-1">13 de Julio a las 13:50 hs</span>
																		</td>
																	...
																	<tr>
																		...
																		<td class="ps-0">
																			<a href="#" class="text-gray-800 fw-bolder text-hover-primary fs-6">Dr. Augusto Cáceres - Hospital Central</a>
																			<span class="text-muted fw-bold d-block mt-1">26 de Julio a las 15:30 hs</span>
																		</td>
															...
															<div class="modal-header">
																<h5 class="modal-title" id="exampleModalLabel">Solicita un nuevo turno</h5>
															...
															<div class="modal-body">
																...
																<form>
																	<div style="margin: 10px;">
																		...
																		<input style="float: right;" type="email">
																	</div>
																	<div style="margin: 10px;">
																		<label>Fecha </label>
															...
															<div class="modal-footer">
																<div id="msj" style="margin-right: 20px;" hidden><p>Su consulta fue enviada con éxito</p></div>
																<button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Cerrar</button>
																<button type="button" class="btn btn-primary" onclick="alerta()" >Guardar</button>
																<script type="text/javascript">function alerta(){document.getElementById('msj').hidden = false;}</script>
															</div>
															</div>
															</div>
															</div>
								...
								<div class="row g-0 g-xl-5 g-xxl-8">
									<div class="col-xl-4">
										...
										<div class="card card-stretch mb-5 mb-xxl-8">
											...
											<div class="card-header align-items-center border-0 mt-5">
												<h3 class="card-title align-items-start flex-column">
													<span class="fw-bolder text-dark fs-3">Historial de turnos</span>
													<span class="text-muted mt-2 fw-bold fs-6">Notificaciones</span>
												</h3>
												<div class="card-toolbar">
													<!--begin::Dropdown-->
											...
											<div class="card-body pt-3">
												...
												<div class="timeline-label">
													...
													<div class="timeline-item">
														<!--begin::Label-->
														<div class="timeline-label fw-bolder text-gray-800 fs-6">1 de Julio</div>
														<!--end::Label-->
														<!--begin::Badge-->
														...
														<!--end::Badge-->
														<!--begin::Text-->
														<div class="fw-mormal timeline-content text-muted ps-3">Dra. Delfina de Castro - 14:30</div>
														<!--end::Text-->
													</div>
													<!--end::Item-->
													<!--begin::Item-->
													<div class="timeline-item">
														<!--begin::Label-->
														<div class="timeline-label fw-bolder text-gray-800 fs-6">30 de Junio</div>
														<!--end::Label-->
														<!--begin::Badge-->
														<div class="timeline-badge">
														...
														<div class="timeline-content d-flex">
															<span class="timeline-content fw-mormal text-muted ps-3">Dr. Tomás Pereira - 17:40</span>
														</div>
														<!--end::Content-->
													</div>
													<!--end::Item-->
													...
													<div class="timeline-item">
														<!--begin::Label-->
														<div class="timeline-label fw-bolder text-gray-800 fs-6">29 de Junio</div>
														<!--end::Label-->
														<!--begin::Badge-->
														<div class="timeline-badge">
														...
														<!--end::Badge-->
														<!--begin::Desc-->
														<div class="timeline-content fw-mormal text-muted ps-3">Arturo Ferreira - 13:55</div>
													...
													<div class="timeline-item">
														<!--begin::Label-->
														<div class="timeline-label fw-bolder text-gray-800 fs-6">2 de Junio</div>
														<!--end::Label-->
														<!--begin::Badge-->
														<div class="timeline-badge">
														...
														<!--end::Badge-->
														<!--begin::Text-->
														<div class="timeline-content fw-mormal text-muted ps-3">Sagrario Marquez - 16:45</div>
														<!--end::Text-->
													</div>
													<!--end::Item-->
													<!--begin::Item-->
													<div class="timeline-item">
														<!--begin::Label-->
														<div class="timeline-label fw-bolder text-gray-800 fs-6">9 de Enero</div>
														<!--end::Label-->
														<!--begin::Badge-->
														<div class="timeline-badge">
															<i class="fa fa-genderless text-danger fs-1"></i>
														...
														<!--end::Badge-->
														<!--begin::Desc-->
														<div class="timeline-content fw-mormal text-muted ps-3">Florencia Villalba - 16:00</div>
													...
													<div class="timeline-item">
														<!--begin::Label-->
														<div class="timeline-label fw-bolder text-gray-800 fs-6">20 de Enero</div>
														<!--end::Label-->
														<!--begin::Badge-->
														<div class="timeline-badge">
															<i class="fa fa-genderless text-primary fs-1"></i>
														...
														<!--end::Badge-->
														<!--begin::Text-->
														<div class="timeline-content fw-mormal text-muted ps-3">Claudia Enriquez - 18:00</div>
														<!--end::Text-->
													</div>
													<!--end::Item-->
													<!--begin::Item-->
													<div class="timeline-item">
														...
														<!--end::Badge-->
														<!--begin::Desc-->
														<div class="timeline-content fw-mormal text-muted ps-3">Roberto Pérez - 13:15</div>
													...
													<div class="timeline-item">
														<!--begin::Label-->
														<div class="timeline-label fw-bolder text-gray-800 fs-6">4 de Enero</div>
														<!--end::Label-->
														<!--begin::Badge-->
														<div class="timeline-badge">
															<i class="fa fa-genderless text-success fs-1"></i>
														...
														<!--end::Badge-->
														<!--begin::Text-->
														<div class="timeline-content fw-mormal text-muted ps-3">Pablo Rodríguez - 14:30</div>
														<!--end::Text-->
													</div>
													<!--end::Item-->
												</div>
									...
									<div class="col-xl-8">
										...
										<div class="card card-stretch mb-5 mb-xxl-8">
											...
											<div class="card-header border-0 pt-5">
												<h3 class="card-title align-items-start flex-column">
													<span class="card-label fw-bolder text-dark fs-3">Administradores</span>
													<span class="text-muted mt-2 fw-bold fs-6">Otorga permisos a otros compañeros de trabajo</span>
												</h3>
															...
															<table class="table table-borderless align-middle">
																...
																<tbody>
																	<tr>
																		...
																		<td class="px-0">
																			<a href="#" class="text-gray-800 fw-bolder text-hover-primary fs-6">Tú</a>
															
																		</td>
																		<td></td>
																		
																		<td class="text-end">
																			<span class="fw-bolder text-primary">Líder</span>
																		</td>
																		<td class="text-end pe-0">
																			<a href="#" class="btn btn-icon btn-bg-light btn-active-primary btn-sm">
																				<!--begin::Svg Icon | path: icons/duotone/Navigation/Arrow-right.svg-->
																	...
																	<tr>
																		...
																		<td class="px-0">
																			<a href="#" class="text-gray-800 fw-bolder text-hover-primary fs-6">Jeremías Fernández</a>
															
																		</td>
																		<td></td>
																		
																		<td class="text-end">
																			<span class="fw-bolder text-primary">Co-Líder</span>
																		</td>
																		<td class="text-end pe-0">
																			<a href="#" class="btn btn-icon btn-bg-light btn-active-primary btn-sm">
																				<!--begin::Svg Icon | path: icons/duotone/Navigation/Arrow-right.svg-->
																	...
																	<tr>
																		...
																		<td class="px-0">
																			<a href="#" class="text-gray-800 fw-bolder text-hover-primary fs-6">Prieto Sebastián</a>
																...
																<div class="stepper-item current" data-kt-stepper-element="nav">
																	<div class="stepper-wrapper">
																		...
																		<div class="stepper-label">
																			<h3 class="stepper-title">Datos</h3>
																			<div class="stepper-desc">Credenciales de la persona</div>
																		</div>
																	</div>
																</div>
																<!--end::Step 1-->
																...
																<div class="pb-5 current" data-kt-stepper-element="content">
																	<div class="w-100">
																		...
																		<div class="pb-5 pb-lg-10">
																			<h3 class="fw-bolder text-dark display-6">Correo</h3>
																		</div>
																		<!--begin::Heading-->
																		<!--begin::Form Group-->
																		<div class="fv-row mb-12">
																			<label class="fs-6 fw-bolder text-dark form-label">Correo electrónico</label>
